...
public class ArraysEx1 {
	...
	public static void main(String[] args) {
		...
		char[] arr4 = Arrays.copyOfRange(arr3, 2, 4);
		System.out.println("**************");
		...
		System.out.println("**************");
		System.out.println("arry1의 주소 : "+Arrays.hashCode(arr1));
		System.out.println("arry2의 주소 : "+Arrays.hashCode(arr2));
		System.out.println("arry4의 주소 : "+Arrays.hashCode(arr4));
		System.out.println("**************");
